...
(function($){
	$.fn.extend({
		leanModal:function(options){
			...
			var common_modal=$('<div class="modal" id="common_modal" style="display:none;"><div class="modal_content" id="modal_content"></div><div class="modal_close"></div></div>');
			$("body").append(common_modal);
			...
			return this.each(function(){
				...
				$(this).click(function(e){
					...
					$(modal_id).css({"display":"block","position":"absolute","opacity":0,"z-index":11000,"left":0,"right":0,"margin":"auto","top":o.top + $(document).scrollTop() + "px"});
