...
$(function() {
  ...
  $('.tabs ul').each(function() {
    ...
    $(this).on('click', 'a', function(e) {
      ...
      $.get(
        '../performer/bulletin_list.php', 
        { is : this.hash.substr(this.hash.length - 1),flv1 : flv1 },
        function(data) {
          $content.html(data);
        }
      );
      ...
      time = setInterval(function() {
        reloadList('../performer/bulletin_list.php');
      }, interval);
  ...
  $('.tabs').on('click', '.show_detail', function(e) {
    ...
    $.get(
      '../performer/bulletin_detail.php', 
      { seqno : seqno, is : is , flv1 : flv1 },
      function(data) {
  ...
  */
  $('.tabs').on('click', '.page_item', function(e) {
    e.preventDefault();
    var url = "../performer/"+ $(this).attr('href'); 
...
function reloadList(url){
  ...
  $.get(
    // 'bulletin_list.php'
    url,
    { is : hash.substr(hash.length - 1) , flv1 : flv1 },
    function(data) {
      $content.html(data);
    }
  );
