...
function check(){
	...
	var sTemp, st_val;
	var av, bPosition;
	st_val=document.F2.meigi.value;
	if(st_val!=""){
...
function remoteStart(){
	remote = window.open('/performer/edit_info/select_bank/search_bank.php','payment','width=470,height=700,scrollbars=yes');
}
