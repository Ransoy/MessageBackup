...
var pagearSmallImg = 'http://www.macherie.tv/test_operator/img/pageearImg/pageear_s.jpg'; 
var pagearSmallSwf = 'http://www.macherie.tv/test_operator/img/pageearImg/pageear_s.swf'; 
var pagearBigImg = 'http://www.macherie.tv/test_operator/img/pageearImg/pageear_b.jpg'; 
var pagearBigSwf = 'http://www.macherie.tv/test_operator/img/pageearImg/pageear_b.swf'; 
...
var jumpTo = 'http://www.macherie.tv/operator/' 
// ŽÖffnet den link im neuen Fenster (new) oder im selben (self)
// Browser target  (new) or self (self)
var openLink = 'self'; 
// ŽÖffnet das pagepeel automatisch wenn es geladen ist (false:deaktiviert | 0.1 - X Sekunden bis zum öffnen) 
// Opens pageear automaticly (false:deactivated | 0.1 - X seconds to open) 
var openOnLoad = 1; 
// Sekunden bis sich das pagepeel wieder schlieŽßt, funktioniert nur im Zusammenhang mit der openOnLoad-Funktion 
...
// Spielt Sound beim schlieŽßen (false:deaktiviert | URL:Mp3 File z.b. www.domain.de/meinsound.mp3)
// Play sound on closing peel (false:deactivated | URL:Mp3 File e.g. www.domain.de/mysound.mp3) 
var playCloseSound = 'false'; 
// Wird das peel geöffnet, bleibt es solange offen bis auf das schlieŽßen-Symbol geklickt wird
// Peel close first if button close will be clicked
var closeOnClick = 'false';
// Text neben schlieŽßen-Symbol
// Close text 
