...
//top banner slides
include_once('top_banner_slides.php');
...
function make_blog_content($db) {
	...
	while ($row = $result->fetchRow()) {
		...
		$tmpl->assign('blog_body', cleanBlogBody($row['body']));
...
if($_SERVER["HTTP_HOST"] != "world.macherie.tv"){
	$str .= '<li class="right"><div class="btn_reload"></div></li>'."\n";
	$str .= '<li class="right"><div class="btn_auto_reload"></div></li>';
	$str .= '<li class="right"><div class="btn_reload_switch"><img src="c/m/images/onoffswitch/off.png" alt="自動更新切り替え" /></div></li>'."\n";

} else {
	$str .= '<li class="right"><div class="btn_reload_w"></div></li>'."\n";
}
