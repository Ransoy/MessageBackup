...
//retval+= '<span style="position: absolute;font-weight:bold;color:#FFF;left:-1px;">0人参加</span>';
//retval+= '<span style="position: absolute;font-weight:bold;color:#FFF;left:1px;">0人参加</span>';
//retval+= '<span style="position: absolute;font-weight:bold;color:#FFF;top:-1px;">0人参加</span>';
//retval+= '<span style="position: absolute;font-weight:bold;color:#FFF;top:1px;">0人参加</span>';
//retval+= '<span style="position: absolute;font-weight:bold;">0人参加</span>';
//retval+= '</div>';
...
function addDebutSP(){
	...
	var post_data = { page : pp, all : 1 };			// all=1 で、ページ数関係なく全レコード取得
	$.ajax({
