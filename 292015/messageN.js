...
$(function() {
	...
	$(document).on('click', '.func_del_message_list_item', function(e){
		...
		if(confirm('・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽH')){
			// execute
		}
	});
	...
	$('.btn_block').on('click', function(e){
		...
		if (!$(this).hasClass('disable')) {
			...
			var to_id	= encodeURIComponent($('#to-id').val());
			if($(this).hasClass('on')){
				if(confirm('・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽB・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ')){
					$(this).removeClass('on');
				...
				if(confirm('・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ')){
					$(this).addClass('on');
	...
	$('#btn_photo').click(function(e){
		...
		if(!isDisableSend){
			...
			$('#input_photo').fadeTo('fast',0);
			 ...
			 alert('・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ');
		}
	});
	...
	$(document).on('click', '#exe_delete_message_list', function(e){
		...
		if(confirm('・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽB・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ')){
	...
	$(document).on('click', '#exe_block_contact_list', function(e){
		...
		if(confirm('・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ')){
			// execute
			$('.message_list_form').submit();
		}
	});
