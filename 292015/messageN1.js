...
$(function() {
	...
	$(document).on('click', '.func_del_message_list_item', function(e){
		...
		if(confirm('髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�ｿｽ')){
			// execute
		}
	});
	...
	$('.btn_block').on('click', function(e){
		...
		if (!$(this).hasClass('disable')) {
			...
			if($(this).hasClass('on')){
				if(confirm('髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�ｿｽ髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏')){
					$(this).removeClass('on');
				...
				if(confirm('髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�ｿｽ)){
					$(this).addClass('on');
		...
		$.post('/ajax/message/load_more.php',
				...
				function(data){
					...
					if(responseDate == date){
							$('#message_detail_area').find('.postdate_box').remove();
					}
					date = lastDate;
	...
	$('#btn_photo').click(function(e){
		...
		if(!isDisableSend){
			...
			$('#input_photo').fadeTo('fast',0);
			 ...
			 alert('髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�ｿｽ);
		}
	});
	...
	$(document).on('click', '#exe_delete_message_list', function(e){
		...
		if(confirm('髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�ｿｽ髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏')){
	...
	$(document).on('click', '#exe_block_contact_list', function(e){
		...
		if(confirm('髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏髏�邱堤筏')){
			// execute
			$('.message_list_form').submit();
		}
	});
	...
	$('#btn_refresh').click(function(e){
		...
		messageAjax = $.ajax({
			type	: 'POST',
			url		: '/ajax/message/message_check_n.php',
			data	: formData,
