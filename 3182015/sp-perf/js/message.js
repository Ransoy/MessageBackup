...
$(function() {
	...
	// message list edit
	$(document).on(event, '.message_list--edit .message_list_item .thumb,.message_list_item .col_left ,.message_list_item .col_center , .message_list--edit .message_list_item .message_data', function(e){
		e.preventDefault();
		e.stopPropagation();
